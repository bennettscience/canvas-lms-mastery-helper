...
from app.admin_models import AuthorizedAdminView, UserView, AdminView
...
admin = Admin(app, name='masteryhelper', template_mode='bootstrap3', index_view=AuthorizedAdminView())
